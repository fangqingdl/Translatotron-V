...
if __name__ == '__main__':
    ...
    parser.add_argument("--vae_weight", type=str, default=None, help="the weight of vae.")
    args = parser.parse_args()

    # conver str to list
    args.patch_size = eval(args.patch_size)

    vae_config = {"dim": args.dim, "image_size": args.image_size, "patch_size": args.patch_size,
